 ...
 * @author cocav
 */
public class frm_estudiantes1 extends javax.swing.JFrame {

/**
     * Creates new form frm_cliente
     */
    Estudiantes obj_estudiantes;
        public frm_estudiantes1() {
        initComponents();
        obj_estudiantes = new Estudiantes();
        tbl_cliente.setModel(obj_estudiantes.leer());
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txt_genero, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        // TODO add your handling code here:
      obj_estudiantes = new Estudiantes(0,txt_carnet.getText(),txt_nombres.getText(),txt_apellidos.getText(),txt_direccion.getText(),txt_telefono.getText(),txt_nacimiento.getText(),txt_genero.getText(),txt_email.getText());
      obj_estudiantes.agregar();
      tbl_cliente.setModel(obj_estudiantes.leer());
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        // TODO add your handling code here:
         obj_estudiantes = new Estudiantes(Integer.valueOf(lbl_id.getText()),txt_carnet.getText(),txt_nombres.getText(),txt_apellidos.getText(),txt_direccion.getText(),txt_telefono.getText(),txt_nacimiento.getText(),txt_genero.getText(),txt_email.getText());
      obj_estudiantes.actualizar();
      tbl_cliente.setModel(obj_estudiantes.leer());
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        // TODO add your handling code here:
        obj_estudiantes = new Estudiantes();
        obj_estudiantes.setId(Integer.valueOf(lbl_id.getText()));
        obj_estudiantes.eliminar();
      tbl_cliente.setModel(obj_estudiantes.leer());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_estudiantes1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_estudiantes1().setVisible(true);
            }
        });
    }
